...
export default function LoginPage() {
  ...
  // sx aplicado diretamente no TextField via seletores de classe MUI
  const fieldSx = {
  ...
  // Campo de senha tem altura flexível por causa do helperText + adornment
  const fieldSenhaAdornmentSx = {
    ...fieldSx,
    '& .MuiOutlinedInput-root': {
      ...fieldSx['& .MuiOutlinedInput-root'],
      pr: 1, // espaço para o ícone não sobrepor o texto
    },
  };
                      ...
                      endAdornment: (
                        <InputAdornment position="end">
                          <IconButton
                            ...
                            disabled={loading}
                            edge="end"
                            sx={{ color: 'text.primary', opacity: 0.6, '&:hover': { opacity: 1 } }}
                            tabIndex={-1}
                          >
                            {mostrarSenhaLogin ? <VisibilityOff /> : <Visibility />}
                          </IconButton>
                        </InputAdornment>
                      ),
                    },
                        ...
                        endAdornment: (
                          <InputAdornment position="end">
                            <IconButton
                              ...
                              tabIndex={-1}
                            >
                              {mostrarSenhaCad ? <VisibilityOff /> : <Visibility />}
                            </IconButton>
                          </InputAdornment>
                        ),
                      },
